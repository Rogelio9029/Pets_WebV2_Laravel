        ...
        <div class="max-w-7xl mx-auto">
            <div x-data="{menu: false}" class="flex justify-between items-center border-b-2 border-gray-100 
                ...
                <div class="-mr-2 -my-2 xl:hidden">
                    <button type="button" @click="menu = !menu" class="bg-white rounded-md p-2 inline-flex items-center 
                ...
                <nav class="hidden xl:flex space-x-10">
                    ...
                    <div x-data="{search: false}" class="relative">
                        <button type="button"
                            ...
                            aria-expanded="false" @click="search = !search">
                        ...
                        <div x-show="search"
                            ...
                            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                <div class="relative flex justify-center bg-white p-5">
                                    <input class="bg-gray-50 outline-none p-4 rounded-tl-lg rounded-bl-lg" type="text"
                                        placeholder="Que vamos buscar hoy" />
                                    <button type="button"
                                        class="text-white rounded-tr-lg rounded-br-lg px-4 bg-yellow-300 text-base font-medium hover:text-black"
                                        aria-expanded="false" @click="alert(2)">
                ...
                <div x-show="menu"
                    ...
                    <div
                        class="rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        <div class="pt-5 pb-6 px-5 space-y-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="-mr-2">
                                    <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 
                                                hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset 
                                                focus:ring-indigo-500" @click="menu = !menu">
                            ...
                            <div class="mt-6">
                                <nav class="grid gap-y-4">
                                    <a href="#" class="p-3 flex items-center rounded-md hover:bg-gray-100">
                                        <svg class="flex-shrink-0 h-6 w-6 text-yellow-500"
                        ...
                        <div class="flex justify-center bg-white p-5">
                            <input class="w-2/3 bg-gray-50 outline-none p-4 rounded-tl-lg rounded-bl-lg" type="text"
                                placeholder="Que vamos buscar hoy" />
                            <button type="button"
                        ...
                        <a href="#"
                            class="bg-gradient-to-r from-yellow-500 via-yellow-600 to-yellow-700 mx-5 flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-lg font-bold text-white">
                            Sign up
                        </a>
