...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('styles/carrouselStyle.css') }}" rel="stylesheet">
    ...
    <div class="relative bg-white">
            <div class="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <nav class="hidden xl:flex space-x-10">
                        ...
                        <a href="{{ route('services') }}" class="text-base font-medium text-gray-500 hover:text-gray-900 relative">
                            <p class="nav px-2">
                                <span>Servicios</span>
                                <span class="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                            </p>
                        </a>
                        <a href="{{ route('contact') }}" class="text-base font-medium text-gray-500 hover:text-gray-900 relative">
                            <p class="nav px-2">
                                <span>Contactanos</span>
                                <span class="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                            </p>
                        </a>
                        <a href="{{ route('about') }}" class="text-base font-medium text-gray-500 hover:text-gray-900 relative">
                            <p class="nav px-2">
                                <span>Nosotros</span>
                                <span class="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                            </p>
                    ...
                    >
                        ...
                        <div class="rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                            <div class="pt-5 pb-6 px-5 space-y-6">
                                ...
                                <div class="mt-6">
                                    <nav class="grid gap-y-4">
                                        <a href="{{ route('services') }}" class="p-3 flex items-center rounded-md hover:bg-gray-100">
                                        ...
                                        <a href="{{ route('contact') }}" class="p-3 flex items-center rounded-md hover:bg-gray-100">
                                            <svg class="flex-shrink-0 h-6 w-6 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        ...
                                        <a href="{{ route('about') }}" class="p-3 flex items-center rounded-md hover:bg-gray-100">
                                            <svg class="flex-shrink-0 h-6 w-6 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            ...
                            <a href="{{ route('register') }}" class="bg-gradient-to-r from-yellow-500 via-yellow-600 to-yellow-700 mx-5 flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-lg font-bold text-white">
                                Sign up
                            </a>
                            <p class="mt-6 py-4 text-center text-lg font-medium text-gray-500">
                                Ya tienes una cuenta?
                                <a href="{{ route('login') }}" class="text-yellow-500 hover:text-yellow-500">
                                    Sign in
                                </a>
                            </p>
                        </div>
            ...
            <div class="bg-yellow-500 p-8">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <ul class="list-reset leading-normal">
                            <li class="text-black hover:text-white">Una empresa que se ganara tu confianza demostrando su profesialismo</li>
                        </ul>
                        </div>
                        ...
                        <ul class="list-reset leading-normal">
                            <li><a href="" class="list-reset leading-normal text-black hover:text-white">Servicios</a></li>
                            <li><a href="" class="list-reset leading-normal text-black hover:text-white">Contactanos</a></li>
                            <li><a href="" class="list-reset leading-normal text-black hover:text-white">Nosotros</a></li>
                        </ul>
                        </div>
        ...
        <script src="{{ asset('scripts/script_Carrousel.js') }}"></script>
        ...
        <script type="text/javascript" >
            const toggle = () => {
                ...
                if(solutions.classList.contains('invisible')) {
                    solutions.classList.remove('invisible') 
                } else {
                    solutions.classList.add('invisible') 
                }
                    // ? 
                       
                    // : 
                    //     solutions.classList.add('invisible transition ease-out duration-200') 
