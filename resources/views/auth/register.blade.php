...
@section('content')
    <div class="min-w-screen md:min-h-screen flex items-center justify-center px-2 py-2">
        <div class="bg-white text-gray-500 rounded-xl shadow-2xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                <img src="{{ asset('images/SignUp.jpg') }}" resizeMode = 'cover'  class="hidden md:block w-1/2" srcset="">
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-5">
                        <h1 class="font-bold text-3xl text-gray-900">REGISTRATE</h1>
                        <p>Que esperas para ser parte de la familia!</p>
                    </div>
                    <div>
                        <div class="flex -mx-3">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTRAR</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('second_name') ? ' has-error' : '' }}">
                            <label for="second_name" class="col-md-4 control-label">Apellido materno</label>
